...
const NavbarMenu = () => {
  ...
  const buildMenu = items => {
    return items.map((item, index) => {
      if (item.children) {
        return <MenuItem key={index} className="border-b-2 border-b-transparent menu-item-active:border-b-gray-900 menu-item-here:border-b-gray-900 lg:ms-2" trigger="hover" toggle="dropdown" dropdownProps={{
