...
const Post3 = () => {
  ...
  return <div className="card">
      <Heading author="Finance Deprt - Annual Report" avatar={{
      icon: 'tab-tablet',
      className: 'flex items-center justify-center uppercase rounded-full size-[50px] shrink-0 bg-primary-light text-primary',
      iconClass: 'text-2xl'
    }} date="1 week ago" />
      ...
      <div>
        ...
        {activeTab === 'likes' && <div id="post_3_likes">
            <Likes />
          </div>}
        {activeTab === 'saves' && <div id="post_3_saves">
            <Saves />
          </div>}
      </div>
    </div>;
