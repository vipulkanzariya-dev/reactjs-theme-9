...
const Post2 = () => {
  ...
  return <div className="card">
      ...
      <div>
        <Tabs postId={2} activeTab={activeTab} setActiveTab={setActiveTab} comments={2} likes="24" saves={16} className="mx-7.5" />

        {activeTab === 'comments' && <div id="post_2_comments">
            <Comments items={comments} />
          </div>}
        {activeTab === 'likes' && <div id="post_2_likes">
            <Likes />
          </div>}
        {activeTab === 'saves' && <div id="post_2_saves">
            <Saves />
          </div>}
      </div>
    </div>;
