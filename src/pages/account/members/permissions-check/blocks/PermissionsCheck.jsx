  ...
  const renderItem = (each, index) => {
    return <tr key={index}>
        ...
        <td className="!py-5.5 text-center">
          <input type="checkbox" className="checkbox checkbox-sm" value="" name="" defaultChecked={each.view} />
        </td>
        <td className="!py-5.5 text-center">
          <input type="checkbox" className="checkbox checkbox-sm" value="" name="" defaultChecked={each.modify} />
        </td>
        <td className="!py-5.5 text-center">
          <input type="checkbox" className="checkbox checkbox-sm" value="" name="" defaultChecked={each.publish} />
        </td>
        <td className="!py-5.5 text-center">
          <input type="checkbox" className="checkbox checkbox-sm" value="" name="" defaultChecked={each.configure} />
        </td>
      </tr>;
  };
