  ...
  const renderItem = (option, index) => {
    return <div key={index} className="flex flex-col gap-2.5">
        <label className="checkbox-group">
          <input type="checkbox" className="checkbox checkbox-sm" defaultChecked={option.checked} name="option" value={option.label} readOnly />
      ...
      <div className="card-body grid gap-7.5 py-5 lg:py-7.5">
        ...
        <div className="flex flex-col gap-4">
          ...
          <label className="flex items-center gap-1.5">
            <input type="checkbox" className="checkbox checkbox-sm" name="send" value="1" readOnly />
